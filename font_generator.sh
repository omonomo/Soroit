...
calt_init() {
    ...
    move_y_calt_colon=$((move_y_math + 82)) # : のY座標移動量
    ...
    move_y_calt_bar=$((move_y_math + 56)) # | のY座標移動量
    ...
    move_y_calt_math=$((- move_y_math - 7)) # +-= のY座標移動量
    ...
    move_y_calt_colon2="75" # : のY座標移動量 (括弧用)
    ...
    move_y_calt_bar2="50" # | のY座標移動量 (括弧用)
